    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col px-6">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-white font-headline">{t('login.title')}</h1>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <span className="flex-1 text-left font-headline text-base">{t('login.googleBtn')}</span>
