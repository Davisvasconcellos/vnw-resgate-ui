...
export default function VolunteerPage() {
  ...
  const handleEnroll = (id: string) => {
    ...
    // In a real app we'd redirect or update global state
  }
    ...
    <main className="min-h-screen bg-surface dark:bg-[#0a1628] flex flex-col pb-32 pt-16 transition-colors">
        ...
        <div className="space-y-4">
          {OPPORTUNITIES.map((req) => (
            <button
              ...
              className="w-full text-left bg-white dark:bg-white/5 rounded-[2rem] p-6 shadow-sm border border-slate-100 dark:border-white/10 hover:shadow-md transition-all relative overflow-hidden group active:scale-[0.98]"
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="font-extrabold text-slate-800 dark:text-white text-lg font-headline leading-tight line-clamp-1">{req.title}</h3>
      ...
      {selectedRequest && (
        <div className="fixed inset-0 z-[100] flex flex-col justify-end">
          ...
          <div className="relative z-10 bg-white dark:bg-[#0d2247] rounded-t-[3rem] px-6 pt-5 pb-32 reveal-pop max-h-[90vh] overflow-y-auto">
            <div className="w-12 h-1.5 rounded-full bg-slate-200 dark:bg-white/10 mx-auto mb-8 shrink-0" />
            
            <div className="flex items-center gap-4 mb-4">
              <div className="w-14 h-14 rounded-2xl bg-green-50 dark:bg-green-900/20 flex items-center justify-center text-[#2E7D32] dark:text-green-400 border border-green-100 dark:border-green-500/20 shadow-sm">
